...
public interface PatternCollection {
    ...
    final String ACCEPTED_NAME_PATTERN = "[ÖÄÜA-Z][öÖäÄüÜßA-z]{3,20}"+SPACE+"+[ÖÄÜA-Z][öÖäÄüÜßA-z]{2,40}";
    //Format: Max Moritz Mustermann
    final String ACCEPTED_NAME_WITH_SECOND_FIRSTNAME_PATTERN = "[ÖÄÜA-Z][öÖäÄüÜßA-z]{3,20}+[-]{1}+[ÖÄÜA-Z][öÖäÄüÜßA-z]{3,20}"+SPACE+"+[ÖÄÜA-Z][öÖäÄüÜßA-z]{2,40}";
    //Format: Max Tester-Mustermann
    final String ACCEPTED_NAME_WITH_SECOND_LASTNAME_PATTERN = "[ÖÄÜA-Z][öÖäÄüÜßA-z]{3,20}"+SPACE+"+[ÖÄÜA-Z][öÖäÄüÜßA-z]{2,40}+[-]{1}+[ÖÄÜA-Z][öÖäÄüÜßA-z]{2,40}";
    //Format: Max Moritz Tester-Mustermann
    final String ACCEPTED_NAME_WITH_SECOND_FIRST_AND_LASTNAME_PATTERN = "[ÖÄÜA-Z][öÖäÄüÜßA-z]{3,20}+[-]{1}+[ÖÄÜA-Z][öÖäÄüÜßA-z]{3,20}"+SPACE+"+[ÖÄÜA-Z][öÖäÄüÜßA-z]{2,40}+[-]{1}+[ÖÄÜA-Z][öÖäÄüÜßA-z]{2,40}";
